...
router.post('/l2/users/register/register-branch', function (req, res) {
    ...
    if (req.session.data['prototype-service'] === 'HTDS') {
        ...
        res.redirect(`/${verNum}/l2/users/register/mobile`);
    }
});

router.post('/l3/users/register/register-branch', function (req, res) {
    ...
    if (req.session.data['prototype-service'] === 'HTDS') {
        ...
        res.redirect(`/${verNum}/l3/users/register/mobile`);
    }
});

router.post('/l4/users/register/register-branch', function (req, res) {
    ...
    if (req.session.data['prototype-service'] === 'HTDS') {
        ...
        res.redirect(`/${verNum}/l4/users/register/mobile`);
    }
});
